...
namespace Ecommerce.Modules.Inventory.Infrastructure.DAL.Migrations
{
    ...
    [Migration("20260329214521_DeletedCategoryRequiredFlagForAuction")]
    partial class DeletedCategoryRequiredFlagForAuction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Modules.Inventory.Domain.Auctions.Entities.Auction", b =>
                {
                    ...
                    b.ToTable("Auctions", "inventory", t =>
                        {
            ...
            modelBuilder.Entity("Ecommerce.Modules.Inventory.Domain.Auctions.Entities.Review", b =>
                {
                    ...
                    b.ToTable("Reviews", "inventory", t =>
                        {
                            t.HasCheckConstraint("CK_Review_Grade", "\"Grade\" >= 1 AND \"Grade\" <= 10");
                        });
                });
                    ...
                    b.ToTable("Products", "inventory", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Product_Reserved", "\"Reserved\" >= 0");

                            t.HasCheckConstraint("CK_Product_VAT", "\"VAT\" >= 0");
                        });
                });
