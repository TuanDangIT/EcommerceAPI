...
namespace Ecommerce.Modules.Orders.Domain.Orders.Entities
{
    public class OrderItem : BaseEntity<int>    
    {
        ...
        public OrderItem(string sku, string name, decimal price, decimal unitPrice, int quantity, string? imagePathUrl)
        {
            if(unitPrice < 0)
            {
        ...
        public OrderItem(string sku, string name, decimal unitPrice, int quantity, string? imagePathUrl)
        {
            SKU = sku;
            Name = name;
