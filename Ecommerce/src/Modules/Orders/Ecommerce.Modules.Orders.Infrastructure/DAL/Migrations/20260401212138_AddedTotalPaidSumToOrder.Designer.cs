...
namespace Ecommerce.Modules.Orders.Infrastructure.DAL.Migrations
{
    ...
    [Migration("20260401212138_AddedTotalPaidSumToOrder")]
    partial class AddedTotalPaidSumToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Modules.Orders.Domain.Orders.Entities.Order", b =>
                {
                    ...
                    b.Property<decimal>("TotalPaidSum")
                    ...
                    b.ToTable("Orders", "orders", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Order_TotalPaidSum", "\"TotalPaidSum\" >= 0");
