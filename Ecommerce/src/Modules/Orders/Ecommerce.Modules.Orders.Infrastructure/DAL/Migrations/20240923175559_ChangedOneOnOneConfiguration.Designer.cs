...
namespace Ecommerce.Modules.Orders.Infrastructure.DAL.Migrations
{
    ...
    [Migration("20240923175559_ChangedOneOnOneConfiguration")]
    partial class ChangedOneOnOneConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Modules.Orders.Domain.Returns.Entities.Return", b =>
                {
                    b.HasOne("Ecommerce.Modules.Orders.Domain.Orders.Entities.Customer", "Customer")
                        .WithOne("Return")
                        .HasForeignKey("Ecommerce.Modules.Orders.Domain.Returns.Entities.Return", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
