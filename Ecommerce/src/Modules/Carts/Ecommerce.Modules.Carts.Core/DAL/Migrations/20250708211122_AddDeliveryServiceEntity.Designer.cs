...
namespace Ecommerce.Modules.Carts.Core.DAL.Migrations
{
    ...
    [Migration("20250708211122_AddDeliveryServiceEntity")]
    partial class AddDeliveryServiceEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Modules.Carts.Core.Entities.DeliveryService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DeliveryServices", "carts", t =>
                        {
                            t.HasCheckConstraint("CK_DeliveryService_Price", "\"Price\" >= 0");
                        });
                    ...
                    b.OwnsOne("Ecommerce.Modules.Carts.Core.Entities.ValueObjects.Shipment", "Shipment", b1 =>
                        {
                            ...
                            b1.HasOne("Ecommerce.Modules.Carts.Core.Entities.DeliveryService", "DeliveryService")
                                .WithMany()
